...
//    self.tabBar.barStyle = UIBarStyleBlack; //去掉tabbar 上黑线
}
#pragma mark - ——————— 初始化VC ————————
-(void)setUpAllChildViewController{
    ...
    //[self.tabBar setBadgeStyle:kCustomBadgeStyleRedDot value:2 atIndex:0];


    PersonalVC *Personal = [[PersonalVC alloc]init];
    [self setupChildViewController:Personal title:@"我的" imageName:@"icon_tabbar_mine" seleceImageName:@"icon_tabbar_mine_selected"];
    
    //[self.tabBar setBadgeStyle:kCustomBadgeStyleNumber value:3 atIndex:1];
