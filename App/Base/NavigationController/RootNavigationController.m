...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.barStyle = UIBaselineAdjustmentNone; // 去掉nav下黑线的另一种方法
}
...
-(id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController animationControllerForOperation:(UINavigationControllerOperation)operation fromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC
{
    ...
    if ([fromVC conformsToProtocol:@protocol(XYTransitionProtocol)] && [toVC conformsToProtocol:@protocol(XYTransitionProtocol)]) {
        ...
        BOOL pinterestNedd = [self isNeedTransition:(UIViewController<XYTransitionProtocol> *)fromVC:(UIViewController<XYTransitionProtocol> *)toVC];
        ...
        BOOL pinterestNedd = [self isNeedTransition:(UIViewController<XYTransitionProtocol> *)toVC];
