...
- (instancetype)initWithFrame:(CGRect)frame withTapBlock:(TapBlock)tapBlock
{
    if (self = [super initWithFrame:frame]) {
        ...
        CGFloat btnW = 60;
        CGFloat btnH = 30;
        _countBtn = [[UIButton alloc] initWithFrame:CGRectMake(KScreenWidth - btnW - 15, HitoStatusHeight, btnW, btnH)];
...
//    _adView.image = [UIImage imageWithContentsOfFile:filePath];
    ...
    NSURL *fileUrl = [NSURL URLWithString:@"http://wwj170928.15.baidusx.com/port/page.gif"]; //加载GIF图片
    ...
    _adView.animationImages = frames;
     _adView.animationDuration = 3.0;
    [_adView startAnimating];
...
- (void)getAdvertisingImage{
    ...
    NSArray *imageArray = @[@"http://wwj170928.15.baidusx.com/port/page.gif"];
