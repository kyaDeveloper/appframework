...
@implementation MyIdCardTextField
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    if (StatusBarAndNavigationBarHeight==88) {
        doneButton.frame=CGRectMake(6, doneButtonY-40, doneButtonW-6, doneButtonH-38);
    }
