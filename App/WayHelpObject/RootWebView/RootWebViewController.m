...
//    if (_isShowCloseBtn) {
        if (self.webView.canGoBack) {
            ...
            [self addNavigationItemWithImageNames:@[@"返回2",@"关闭"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2000,@2001]];
        }else{
            ...
            if (kiOS9Later) {
                [self addNavigationItemWithImageNames:@[@"返回2"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2001]];
            }
        }
//    }
}
